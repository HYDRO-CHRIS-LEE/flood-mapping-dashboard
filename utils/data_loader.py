...
Supports 24 Sentinel-1 SAR flood events.
"""
...
# ── All 24 flood events (Sentinel-1 SAR available for all) ────────
ALL_EVENTS = {
    # ── Original 4 ───────────────────────────────────────────────
    ...
    "la2025":       {"label": "LA Atmospheric River",       "year": 2025, "region": "Southern CA, USA",           "color": "#10b981"},
    # ── Additional 20 ────────────────────────────────────────────
    "myanmar2015":  {"label": "Myanmar Cyclone Komen",      "year": 2015, "region": "Irrawaddy Delta, Myanmar",   "color": "#8b5cf6"},
    "chennai2015":  {"label": "Chennai Flood",              "year": 2015, "region": "Tamil Nadu, India",          "color": "#ec4899"},
    ...
    "bangladesh2017":{"label":"Bangladesh Flood",           "year": 2017, "region": "Sylhet / Brahmaputra Basin", "color": "#6366f1"},
    "kerala2018":   {"label": "Kerala Flood",               "year": 2018, "region": "Kerala, India",              "color": "#84cc16"},
    "japan2018":    {"label": "Japan Torrential Rain",      "year": 2018, "region": "Okayama / Hiroshima, Japan", "color": "#e11d48"},
    ...
    "kalimantan2021":{"label":"Kalimantan Flood",           "year": 2021, "region": "South Kalimantan, Indonesia","color": "#38bdf8"},
    ...
    "afghanistan2024":{"label":"Afghanistan Flash Flood",   "year": 2024, "region": "Baghlan Province, Afghanistan","color": "#f472b6"},
    "tennessee2021":{"label": "Tennessee Flash Flood",      "year": 2021, "region": "Humphreys County, TN, USA",  "color": "#34d399"},
}
...
EVENT_BOUNDS = {
    ...
    "la2025":        [-118.5, 34.0,-117.5,  34.6],
    "myanmar2015":   [ 94.5,  15.5,  96.5,  17.5],
    "chennai2015":   [ 80.0,  12.8,  80.5,  13.3],
    "louisiana2016": [-91.5,  30.0, -90.0,  31.0],
    "srilanka2017":  [ 80.0,   6.0,  81.5,   7.5],
    "bangladesh2017":[ 91.5,  24.5,  92.5,  25.5],
    "kerala2018":    [ 76.0,   9.0,  77.5,  10.5],
    "japan2018":     [133.0,  34.5, 134.5,  35.5],
    ...
    "kalimantan2021":[ 114.5,-4.0,  116.0,  -2.0],
    ...
    "afghanistan2024":[ 68.0, 35.5,  70.0,  37.0],
    "tennessee2021": [-87.5,  35.8, -87.0,  36.3],
}
...
EVENT_CENTERS = {
    ...
    "chennai2015":   [ 13.1,   80.25],
    "louisiana2016": [ 30.5,  -90.75],
    "srilanka2017":  [  6.75,  80.75],
    "bangladesh2017":[ 25.0,   92.0 ],
    "kerala2018":    [  9.75,  76.75],
    "japan2018":     [ 35.0,  133.75],
    "mozambique2019":[-19.25,  34.75],
    "iran2019":      [ 32.0,   49.0 ],
    "china2020":     [ 29.75, 116.25],
    "sudan2020":     [ 15.75,  33.25],
    "germany2021":   [ 50.4,    7.0 ],
    "kalimantan2021":[ -3.0,  115.25],
    "nigeria2022":   [  5.75,   6.75],
    "libya2023":     [ 32.5,   22.75],
    "somalia2023":   [  2.75,  45.75],
    "brazil2024":    [-30.25, -52.0 ],
    "valencia2024":  [ 39.25,  -0.5 ],
    "afghanistan2024":[ 36.25,  69.0 ],
    "tennessee2021": [ 36.05, -87.25],
}

EVENT_ZOOM = {
    "harvey": 9, "pakistan": 8, "dubai": 10, "la2025": 9,
    "myanmar2015": 8, "chennai2015": 11, "louisiana2016": 9,
    "srilanka2017": 9, "bangladesh2017": 9, "kerala2018": 9,
    "japan2018": 9, "mozambique2019": 9, "iran2019": 8,
    "china2020": 8, "sudan2020": 8, "germany2021": 10,
    "kalimantan2021": 8, "nigeria2022": 9, "libya2023": 10,
    "somalia2023": 9, "brazil2024": 8, "valencia2024": 9,
    "afghanistan2024": 8, "tennessee2021": 10,
}
...
EVENT_DATES = {
    ...
    "la2025":        {"before": ("2024-11-01","2025-01-06"), "flood": ("2025-01-17","2025-02-20")},
    "myanmar2015":   {"before": ("2015-06-01","2015-07-20"), "flood": ("2015-07-25","2015-08-20")},
    "chennai2015":   {"before": ("2015-10-01","2015-11-01"), "flood": ("2015-11-15","2015-12-10")},
    ...
    "bangladesh2017":{"before": ("2017-06-01","2017-07-20"), "flood": ("2017-08-01","2017-09-01")},
    "kerala2018":    {"before": ("2018-06-01","2018-07-31"), "flood": ("2018-08-10","2018-09-01")},
    "japan2018":     {"before": ("2018-06-01","2018-06-28"), "flood": ("2018-07-05","2018-07-15")},
    ...
    "kalimantan2021":{"before": ("2021-01-01","2021-01-10"), "flood": ("2021-01-12","2021-02-01")},
    ...
    "afghanistan2024":{"before":("2024-05-01","2024-05-08"),"flood": ("2024-05-10","2024-05-25")},
    "tennessee2021": {"before": ("2021-08-01","2021-08-20"), "flood": ("2021-08-21","2021-09-05")},
}
...
def tif_to_rgba(band, colormap="gray"):
    ...
    rgba   = (cm.get_cmap(colormap)(normed) * 255).astype(np.uint8)
    rgba[band == 0, 3] = 0
    return rgba
